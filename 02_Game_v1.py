from tkinter import *
from functools import partial  # to prevent unwanted widnows
...
class game:
    ...
    def __init__(self, how_many):
        ...
        for item in score_round_labels_list:
            ...
            score_round_labels_ref.append(item)

        # retrieve labels so they can be configured later
        self.heading_label = play_labels_ref[0]
        self.target_label = score_round_labels_ref[0]
        self.target_label = score_round_labels_ref[1]
